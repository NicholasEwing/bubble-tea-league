...
async function createProviderId() {
  ...
  const res = await fetch(`${process.env.TOURNAMENT_ENDPOINT}/providers`, {
    method: "POST",
...
async function createTournamentId(providerId, name) {
  ...
  const res = await fetch(`${process.env.TOURNAMENT_ENDPOINT}/tournaments`, {
    method: "POST",
...
async function generateTournamentCodes(tournamentId, count) {
  ...
  const res = await fetch(
    `${process.env.TOURNAMENT_ENDPOINT}/codes?count=${count}&tournamentId=${tournamentId}`,
    {
      method: "POST",
