    ...
    <div className="match flex">
      <div className="HomeVodsMatch relative flex w-full cursor-pointer pb-4 font-medium">
        <div className="thumbnail relative h-20 w-32">
          <div className="background absolute left-0 top-0 z-0 h-full w-full overflow-hidden">
            <div className="image-wrapper absolute -top-[26%] -left-[4.5%] z-[1] h-[111%] w-1/2 rotate-[10deg] scale-[1.3] overflow-hidden">
              <div
                className={`team-image absolute top-0 left-[9%] h-[200%] w-[200%] -rotate-[10deg] scale-[.77] bg-gray-500 bg-[url('/teams/null.png')] bg-contain bg-no-repeat opacity-50 [background-position-x:-25px] [background-position-y:-25px]`}
                style={{
                  backgroundImage: `url(
                        "/teams/null.png"
                      )`,
            ...
            <div className="image-wrapper absolute -top-[30%] -right-[10.5%] z-0 h-[130%] w-1/2 rotate-[10deg] scale-[1.3] overflow-hidden">
              <div
                className={`team-image absolute right-0 top-[11%] -left-[87%] h-[200%] w-[200%] -rotate-[10deg] scale-[.77] bg-gray-400 bg-[url('/teams/null.png')] bg-contain bg-no-repeat opacity-50 [background-position-x:42px] [background-position-y:-25px]`}
                style={{
                  backgroundImage: `url(
                        "/teams/null.png"
                      )`,
        ...
        <div className="description relative flex flex-col pl-4">
          ...
          <div className="match-title">TL vs 100 – Round 7</div>
        </div>
      </div>
    </div>
  );
