        ...
        <div className="ml-3">
          ...
          <div className="mt-2 text-sm text-yellow-700">
            ...
            <ul role="list" className="my-2 list-disc space-y-1 pl-5">
              ...
              <li>
                Always ensure you&apos;re using the correct code depending on
                the team you&apos;re facing.
              </li>
            </ul>
            <p>
              ...
              <br />
              Only use the tournament codes associated with your team&apos;s
              matches. Using the incorrect code or sharing codes could
              compromise the entire tournament by allowing third-parties to
