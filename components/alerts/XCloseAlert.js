...
export default function XCloseAlert({ success = true, dismissHandler }) {
  const successStyles =
  ...
  return (
    <div className="mx-1 -my-0.5 flex">
      <button
        ...
        } px-2 rounded-md text-sm font-medium focus:outline-none focus:ring-1 focus:ring-offset-1`}
      >
        <svg
